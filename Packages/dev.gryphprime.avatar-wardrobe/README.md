...
Enable prerelease packages and install Avatar Wardrobe. VPM resolves VRChat SDK
...
This initial VPM beta has C# compilation and packaging checks, but has not yet
